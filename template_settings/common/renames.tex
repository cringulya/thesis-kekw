...
%%
%%
\newcommand{\Author}{А.И. Сон} % И.О. Фамилия автора 
\newcommand{\AuthorFull}{Сон Артём Игоревич} % Фамилия Имя Отчество автора
\newcommand{\AuthorFullDat}{Сон Артёму Игоревичу} % Фамилия Имя Отчество автора в дательном падеже (Кому? Студенту...)
\newcommand{\AuthorFullVin}{Сон Артёма Игоревича} % в винительном падеже (Кого? что?  Програмиста ...)
...
%%% Первый консультант
\newcommand{\ConsultantExtraFull}{Васильев Антон Аркадьевич} % Фамилия Имя Отчетство дополнительного консультанта 
\newcommand{\ConsultantExtra}{A.A.\,Васильев} % И. О. Фамилия дополнительного консультанта 
\newcommand{\ConsultantExtraDegree}{ведущий программист компьютерной графики
	компании "Saber Interactive"} % 
\newcommand{\ConsultantExtraVin}{A.A.\,Васильева} % И. О. Фамилия дополнительного консультанта в винительном падеже (Кого? что? Руководителя ...)
...
%%
%%
\renewcommand{\thesisTitle}{Генерация реалистичной водной поверхности}
\newcommand{\thesisDegree}{дипломная работа}% дипломный проект, дипломная работа, магистерская диссертация %c 2020
\newcommand{\thesisTitleEn}{Title of the thesis} %2020
\newcommand{\thesisDeadline}{31.95.2024}
\newcommand{\thesisStartDate}{03.05.2024}
...
\newcommand{\thesisOPTitle}{Прикладная математика и информатика}% наименование образовательной программы
%%
%%
\newcommand{\institute}{
	% Название института
...
\newcommand{\practiceTitle}{Генерация реалистичной водной поверхности}
...
\newcommand{\HeadTitle}{Генерация реалистичной водной поверхности}
